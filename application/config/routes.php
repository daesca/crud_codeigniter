...
*/
//$route['default_controller'] = 'welcome';
$route['default_controller'] = 'categories/main';
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;


$route['categories/index']['get'] = 'categories/main/index';
$route['categories/create'] = 'categories/create/index';
$route['categories/store']['post'] = 'categories/create/store';
